...
/*int main(int argc, char* argv[]) {
    ...
    conjunto ChicagoDB;
    load(ChicagoDB, "crimenes100.csv",1);    
*/
...
int main(int argc, char* argv[]) {
    ...
    conjunto ChicagoDB;
    load(ChicagoDB, "crimenes100.csv",2);
